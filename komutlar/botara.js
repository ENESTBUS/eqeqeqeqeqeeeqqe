...
exports.run = async (client, msg, args) => {
    ...
    if(!args[0]) {
      return msg.channel.send(new Discord.MessageEmbed().setDescription('Lütfen bir bot ID\'i giriniz!').setColor("RANDOM"))
    }
    ...
    .setColor("RANDOM")
    .setThumbnail(c)
    .setTitle(`Suspects Botlist - Bot Arama`)
...
exports.help = {
  name: 'bot-ara',
  description: 'SuspectsbotList sistemindeki botları aramanızı sağlar.',
